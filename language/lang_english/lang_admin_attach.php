...
$lang['Upload_directory_explain'] = 'Enter the relative path from your Icy Phoenix installation to the Attachments upload directory. For example, enter <b>files</b> if your Icy Phoenix Installation is located at http://www.yourdomain.com/ip and the Attachment Upload Directory is located at http://www.yourdomain.com/ip/files.';
$lang['Attach_img_path'] = 'Attachment Posting Icon';
$lang['Attach_img_path_explain'] = 'This Image is displayed next to Attachment Links in individual Posts. Leave this field empty if you don\'t want an icon to be displayed. This Setting will be overwritten by the Settings in Extension Groups Management.';
...
$lang['Attach_display_order_explain'] = 'Choose whether to display the Attachments in Posts/PMs in Descending Filetime Order (Newest Attachment First) or Ascending Filetime Order (Oldest Attachment First).';
...
$lang['Attach_quota_explain'] = 'Maximum Disk Space ALL Attachments can hold on your Web space. A value of 0 means \'unlimited\'.';
...
$lang['Default_quota_limit_explain'] = 'Select the Default Quota Limit automatically assigned to newly registered Users, and Users without a defined Quota Limit. The Option \'No Quota Limit\' is for \'not\' using any Attachment Quotas, instead using the default Settings you have defined within this Management Panel.';
...
$lang['Shadow_attachments_explain'] = 'Delete attachment data from posts when the files are missing from your file system, and delete files that are no longer attached to any posts. You can download or view a file if you click on it; if no link is present, the file does not exist.';
...
$lang['Shadow_attachments_row_explain'] = 'Delete all post attachment data for files that don\'t exist on your file system.';
...
$lang['Manage_extensions_explain'] = 'Manage your File Extensions. If you want to allow/disallow an Extension to be uploaded, please use the Extension Groups Management.';
...
$lang['Manage_extension_groups_explain'] = 'Add, delete and modify your Extension Groups, you can disable Extension Groups, assign a special Category to them, change the download mechanism and you can define an Upload Icon which will be displayed in front of an Attachment belonging to the Group.';
...
$lang['Manage_categories_explain'] = 'Set up Special Parameters and Conditions for the Special Categories assigned to an Extension Group.';
...
$lang['Max_image_size_explain'] = 'Define the maximum allowed Image Dimension to be attached (Width x Height in pixels).<br />If it is set to 0x0, this feature is disabled. With some Images this Feature will not work due to limitations in PHP.';
...
$lang['Image_min_thumb_filesize_explain'] = 'If an Image is smaller than this defined Filesize, no Thumbnail will be created, because it\'s small enough.';
$lang['Image_imagick_path'] = 'Imagick Program (Complete Path)';
$lang['Image_imagick_path_explain'] = 'Enter the Path to the conversion program of imagick, normally /usr/bin/convert (on windows: c:/imagemagick/convert.exe).';
...
$lang['Test_settings_successful'] = 'Settings Test completed, configuration seems to be fine.';
