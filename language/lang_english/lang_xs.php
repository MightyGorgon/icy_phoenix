...
$lang['xs_configuration_explain'] = 'Change the eXtreme Styles configuration.';
$lang['xs_default_style'] = 'Default Style';
$lang['xs_default_style_explain'] = 'Change the default forum style and switch users from one style to another.';
$lang['xs_manage_cache'] = 'Manage Cache';
$lang['xs_manage_cache_explain'] = 'Manage cached files.';
$lang['xs_import_styles'] = 'Import Styles';
$lang['xs_import_styles_explain'] = 'Download and install .style files.';
$lang['xs_export_styles'] = 'Export Styles';
$lang['xs_export_styles_explain'] = 'Save a style from your forum as a .style file and then easily transfer it to another forum or another website.';
$lang['xs_clone_styles'] = 'Clone Styles';
$lang['xs_clone_styles_explain'] = 'Quickly clone styles or a whole template.';
$lang['xs_download_styles'] = 'Download Styles';
$lang['xs_download_styles_explain'] = 'Quickly download and install styles from websites. You can configure a list of websites yourself.';
$lang['xs_install_styles'] = 'Install Styles';
$lang['xs_install_styles_explain'] = 'Install styles that are already uploaded to your forum.';
$lang['xs_uninstall_styles'] = 'Uninstall Styles';
$lang['xs_uninstall_styles_explain'] = 'Remove styles from your forum.';
$lang['xs_edit_templates_explain'] = 'Edit tpl files online.';
$lang['xs_edit_styles_data'] = 'Edit Styles Data';
$lang['xs_edit_styles_data_explain'] = 'Edit style variables. It is used by some styles, but most styles don\'t use it and use a css file instead.';
$lang['xs_export_styles_data'] = 'Export Styles Data';
$lang['xs_export_styles_data_explain'] = 'Save style variables to theme_info.cfg.';
$lang['xs_check_for_updates'] = 'Check for Updates';
$lang['xs_check_for_updates_explain'] = 'Check for updated versions of styles and mods installed on your forum.';
...
$lang['xs_ftp_comment3'] = 'Warning: FTP functions are disabled on this server. You will not be able to use eXtreme Styles functions that require FTP access.';
...
$lang['xs_ftp_log_connected'] = 'connected. logging in...';
...
$lang['xs_ftp_path'] = 'FTP Path to Icy Phoenix';
...
$lang['xs_config_warning_explain'] = 'Cache directory is not writable. eXtreme Styles can attempt to fix this problem.<br /><a href="{URL}">Click here</a> to try to change access mode to cache directory.<br /><br />If cache doesn\'t work on your server for some reason don\'t worry - eXtreme Styles<br />increases forum speed many times even without cache.';

$lang['xs_config_maintitle'] = 'eXtreme Styles mod Configuration';
$lang['xs_config_subtitle'] = 'The configuration for eXtreme Styles. If you don\'t understand what certain variables do then don\'t change it.';
...
$lang['xs_config_show_error_explain'] = 'This feature enables/disables errors in tpl files that the user has used incorrectly &lt;!-- INCLUDE filename --&gt;';
...
$lang['xs_config_use_cache_explain'] = 'Cache is saved to disk and it will accelerate the templates system because there would be no need to compile template every time it is shown.';

$lang['xs_config_auto_compile'] = 'Automatically save cache';
$lang['xs_config_auto_compile_explain'] = 'This will automatically compile templates that are not cached and save to the cache directory.';
...
$lang['xs_config_php_explain'] = 'This is the extension of cached files. Files are stored in php format so default extension is "php". Do not include the dot';
...
$lang['xs_cache_confirm'] = 'If you have many styles it might cause a huge server load. Are you sure you want to continue?';
...
$lang['xs_import_explain'] = 'Import styles. You can also automatically install and update styles.<br /><br />Note: If you have added any mods (except for eXtreme Styles mod) on this forum then you should be careful when importing styles because not all are compatible with your forum. You can only install styles that have the same modifications as the other styles that you\'ve configured on your forums.';
...
$lang['xs_download_explain2'] = 'Quickly download and install styles directly from different websites. Click on the link near the website name and you will be redirected to a style downloads page.<br /><br />You can also manage the list of websites.';
...
$lang['xs_style_header_error_invalid2'] = 'Invalid file. Presumably, the file is not an eXtreme Styles mod-compatible style or invalid version.';
...
$lang['xs_import_tpl_comment'] = 'Upload a template to your forum. If a template with this name already exists on your forum this feature will automatically overwrite old files so it can also be used to update styles.<br /><br />This feature can also automatically install styles. If you want to install a style after importing it then select one or more styles below.';
...
$lang['xs_clone_style_explain'] = 'Quickly clone style or whole template.<br /><br />Warning: If you are copying a template make sure author of the original template allows you to do this (unless it is subSilver - you can do whatever you want with subSilver). Usually authors allow you to modify their styles, but modified styles should not be distributed.';
$lang['xs_clone_style_explain2'] = 'Create a new style for a template. This feature will not copy any files - it will add an entry in database for your new style. Both old and new style will share same templates.';
$lang['xs_clone_style_explain3'] = 'Enter name for the new style that you are going to create and click "clone" button.';
$lang['xs_clone_style_explain4'] = 'This feature allows you to clone a template. You can also copy all styles associated with that template. Later you can safely edit the tpl files for the new template and the old template will not be affected.';
...
$lang['xs_uninstall_styles_explain2'] = 'This is a list of styles that are installed on your forum. Click on the "uninstall" link to remove some styles from the forum. Uninstalling is safe - all users who employ the style that is being uninstalled will be switched to the default forum style. Also, uninstalling will automatically delete the cache for that style.';
...
$lang['xs_uninstall_default'] = 'You cannot remove the default style. To change default style <a href="{URL}">click here</a>.';
...
*/
$lang['xs_edit_template_comment1'] = 'Edit templates. File browser shows only editable files.';
$lang['xs_edit_template_comment2'] = 'Edit templates.';
...
$lang['xs_editdata_explain'] = 'Edit the database data for installed styles. Some styles ignore database values and use css files instead, and some styles use only some of database values.';
