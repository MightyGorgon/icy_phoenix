...
*/
$lang['Rules_attach_can'] = 'You <b>can</b> attach files';
$lang['Rules_attach_cannot'] = 'You <b>cannot</b> attach files';
$lang['Rules_download_can'] = 'You <b>can</b> download files';
$lang['Rules_download_cannot'] = 'You <b>cannot</b> download files';
...
$lang['Attachment_php_size_overrun'] = 'The Attachment is too big.<br />Maximum Upload Size: %d MB.<br />Please note that this Size is defined in php.ini, this means it\'s set by PHP and the Attachment Mod cannot override this value.'; // replace %d with ini_get('upload_max_filesize')
...
$lang['Attach_quota_reached'] = 'Sorry, but the maximum filesize for all Attachments has been reached. Please contact the Board Administrator if you have questions.';
$lang['Too_many_attachments'] = 'Attachment cannot be added, since the max. number of %d Attachments in this post has been reached'; // replace %d with maximum number of attachments
...
$lang['Attach_quota_receiver_pm_reached'] = 'Sorry, but the maximum filesize for all Attachments in the Private Message Folder of \'%s\' has been reached. Please let him/her know, or wait until he/she has deleted some of his/her Attachments.';

// Errors -> Download
$lang['No_attachment_selected'] = 'You haven\'t selected an attachment to download or view.';
$lang['Error_no_attachment'] = 'The selected Attachment no longer exists';
...
$lang['Attachbox_limit'] = 'Attachbox [%d%% full]';
