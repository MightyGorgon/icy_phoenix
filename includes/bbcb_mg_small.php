...
{
	$pafiledb_template->set_filenames(array('bbcb_mg_small' => 'bbcb_mg_small.tpl'));
}
else
{
	$template->set_filenames(array('bbcb_mg_small' => 'bbcb_mg_small.tpl'));
}
...
$parsing_template = array(
	...
	'L_BBCB_MG_SPOIL' => $lang['bbcb_mg_spoil'],
