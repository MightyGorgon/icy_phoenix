...
<!-- END ok -->
	...
	<font face="Verdana" size="1" color="#FFFFFF">CrackerTracker Professional &copy; 2004 - {YEAR} <a href="http://www.cback.de" target="_blank" style="color:#FDFF00">CBACK.de</a></font>
</body>
</html>