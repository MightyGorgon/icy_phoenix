...
$lang['UpdateCompleted_phpBB'] = 'phpBB update completed, now you can upgrade to Icy Phoenix!';
...
$lang['Update_phpBB'] = 'Update phpBB DB (if needed)';
$lang['Remove_BBCodeUID'] = 'Process all posts: remove BBCode UID, replace text, remove old BBCodes';
$lang['Merge_PostsTables'] = 'Merge posts tables';
$lang['Update_IcyPhoenix'] = 'Update Icy Phoenix DB';
$lang['Upload_NewFiles'] = 'Upload all new files';
$lang['Adjust_Config'] = 'Update constants in config.php (only works if files are writeable)';
$lang['Adjust_CMSPages'] = 'Update constants in CMS pages (only works if files are writeable)';
$lang['MoveImagesAlbum'] = 'Move album images (optional: only if you want to use posted images into subfolders)';
$lang['MoveImages'] = 'Move posted images (optional: only if you want to use posted images into subfolders)';
$lang['Clean_OldFiles'] = 'Clean Old Files';

$lang['ColorsLegend'] = 'Colors Legend';
$lang['ColorsLegendRed'] = 'Red: this action is required and have to be performed manually';
$lang['ColorsLegendOrange'] = 'Orange: this action is required and the script could perform it automatically (if requirements are met)';
$lang['ColorsLegendGray'] = 'Gray: this action may not be needed and can be performed automatically';
$lang['ColorsLegendBlue'] = 'Blue: this action is optional and can be performed automatically (may require manual edits on some files though)';
$lang['ColorsLegendGreen'] = 'Green: this action is suggested and can be performed automatically (if requirements are met)';
