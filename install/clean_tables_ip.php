...
$valid_fields = array(
	...
	$table_prefix . 'categories' => array('cat_id', 'cat_title', 'cat_order', 'cat_main_type', 'cat_main', 'cat_desc', 'icon'),
	...
	$table_prefix . 'cms_blocks' => array('bid', 'layout', 'layout_special', 'title', 'content', 'bposition', 'weight', 'active', 'blockfile', 'view', 'cache', 'cache_time', 'block_bbcode_uid', 'type', 'border', 'titlebar', 'background', 'local', 'edit_auth', 'groups'),
	...
	$table_prefix . 'cms_layout_special' => array('lsid', 'name', 'filename', 'template', 'global_blocks', 'page_nav', 'config_vars', 'view', 'edit_auth', 'groups'),
	...
	$table_prefix . 'dl_bug_tracker' => array('report_id', 'df_id', 'report_title', 'report_text', 'report_uid', 'report_file_ver', 'report_date', 'report_author_id', 'report_assign_id', 'report_assign_date', 'report_status', 'report_status_date', 'report_php', 'report_db', 'report_forum'),
	$table_prefix . 'dl_comments' => array('dl_id', 'id', 'cat_id', 'user_id', 'username', 'comment_time', 'comment_edit_time', 'comment_text', 'bbcode_uid', 'approve'),
	...
	$table_prefix . 'downloads' => array('id', 'description', 'file_name', 'klicks', 'free', 'extern', 'long_desc', 'sort', 'cat', 'hacklist', 'hack_author', 'hack_author_email', 'hack_author_website', 'hack_version', 'hack_dl_url', 'test', 'req', 'todo', 'warning', 'mod_desc', 'bbcode_uid', 'mod_list', 'file_size', 'change_time', 'add_time', 'rating', 'file_traffic', 'overall_klicks', 'approve', 'add_user', 'change_user', 'last_time', 'down_user', 'thumbnail', 'broken'),
	$table_prefix . 'downloads_cat' => array('id', 'parent', 'path', 'cat_name', 'sort', 'description', 'rules', 'bbcode_uid', 'auth_view', 'auth_dl', 'auth_up', 'auth_mod', 'must_approve', 'allow_mod_desc', 'statistics', 'stats_prune', 'comments', 'cat_traffic', 'cat_traffic_use', 'allow_thumbs', 'auth_cread', 'auth_cpost', 'approve_comments', 'bug_tracker'),
	...
	$table_prefix . 'forums' => array('forum_id', 'cat_id', 'forum_name', 'forum_desc', 'forum_status', 'thank', 'forum_order', 'forum_posts', 'forum_topics', 'forum_last_post_id', 'forum_notify', 'forum_link', 'forum_link_internal', 'forum_link_hit_count', 'forum_link_hit', 'icon', 'main_type', 'prune_next', 'prune_enable', 'auth_view', 'auth_read', 'auth_post', 'auth_reply', 'auth_edit', 'auth_delete', 'auth_sticky', 'auth_announce', 'auth_globalannounce', 'auth_news', 'auth_cal', 'auth_vote', 'auth_pollcreate', 'auth_attachments', 'auth_download', 'auth_ban', 'auth_greencard', 'auth_bluecard', 'auth_rate', 'forum_rules', 'rules_display_title', 'rules_custom_title', 'rules_in_viewforum', 'rules_in_viewtopic', 'rules_in_posting', 'forum_postcount'),
	...
	$table_prefix . 'kb_articles' => array('article_id', 'article_category_id', 'article_title', 'article_description', 'article_date', 'article_author_id', 'username', 'bbcode_uid', 'article_body', 'article_type', 'approved', 'topic_id', 'views', 'article_rating', 'article_totalvotes'),
	...
	$table_prefix . 'megamail' => array('mail_id', 'mailsession_id', 'group_id', 'email_subject', 'email_body', 'batch_start', 'batch_size', 'batch_wait', 'status', 'user_id'),
	$table_prefix . 'news' => array('news_id', 'news_category', 'news_image'),
	$table_prefix . 'notes' => array('id', 'text'),
	$table_prefix . 'optimize_db' => array('cron_enable', 'cron_every', 'cron_next', 'cron_count', 'cron_lock', 'show_begin_for', 'show_not_optimized'),
	...
	$table_prefix . 'pa_comments' => array('comments_id', 'file_id', 'comments_text', 'comments_title', 'comments_time', 'comment_bbcode_uid', 'poster_id'),
	...
	$table_prefix . 'posts' => array('post_id', 'topic_id', 'forum_id', 'poster_id', 'post_time', 'poster_ip', 'post_username', 'enable_bbcode', 'enable_html', 'enable_smilies', 'enable_sig', 'post_edit_time', 'post_edit_count', 'post_edit_id', 'post_attachment', 'post_bluecard', 'enable_autolinks_acronyms'),
	$table_prefix . 'posts_text' => array('post_id', 'bbcode_uid', 'post_subject', 'post_text', 'post_text_compiled', 'edit_notes'),
	...
	$table_prefix . 'privmsgs_text' => array('privmsgs_text_id', 'privmsgs_bbcode_uid', 'privmsgs_text'),
	...
	$table_prefix . 'shout' => array('shout_id', 'shout_username', 'shout_user_id', 'shout_group_id', 'shout_session_time', 'shout_ip', 'shout_text', 'shout_active', 'enable_bbcode', 'enable_html', 'enable_smilies', 'enable_sig', 'shout_bbcode_uid'),
	...
	$table_prefix . 'topics' => array('topic_id', 'forum_id', 'topic_title', 'topic_desc', 'topic_poster', 'topic_time', 'topic_views', 'topic_replies', 'topic_status', 'topic_vote', 'topic_type', 'topic_first_post_id', 'topic_last_post_id', 'topic_moved_id', 'topic_attachment', 'title_compl_infos', 'news_id', 'topic_calendar_time', 'topic_calendar_duration', 'topic_rating', 'topic_show_portal'),
