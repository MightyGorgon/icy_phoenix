...
$valid_fields = array(
	...
	$table_prefix . 'cms_block_settings' => array('bs_id', 'user_id', 'name', 'content', 'blockfile', 'view', 'type', 'edit_auth', 'groups', 'locked'),
	$table_prefix . 'cms_block_variable' => array('bvid', 'bid', 'label', 'sub_label', 'config_name', 'field_options', 'field_values', 'type', 'block'),
	$table_prefix . 'cms_blocks' => array('bid', 'bs_id', 'block_cms_id', 'layout', 'layout_special', 'title', 'bposition', 'weight', 'active', 'border', 'titlebar', 'background', 'local', 'edit_auth'),
	$table_prefix . 'cms_config' => array('id', 'bid', 'config_name', 'config_value'),
	$table_prefix . 'cms_layout' => array('lid', 'name', 'filename', 'template', 'layout_cms_id', 'global_blocks', 'page_nav', 'config_vars', 'view', 'edit_auth', 'groups'),
