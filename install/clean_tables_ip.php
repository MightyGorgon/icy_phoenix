...
$valid_fields = array(
	...
	$table_prefix . 'drafts' => array('draft_id', 'user_id', 'forum_id', 'topic_id', 'save_time', 'draft_subject', 'draft_message'),
	...
	$table_prefix . 'forums' => array('forum_id', 'forum_type', 'parent_id', 'left_id', 'right_id', 'cat_id', 'main_type', 'forum_parents', 'forum_name', 'forum_name_clean', 'forum_desc', 'forum_status', 'forum_order', 'forum_posts', 'forum_topics', 'forum_last_topic_id', 'forum_last_post_id', 'forum_last_poster_id', 'forum_last_post_subject', 'forum_last_post_time', 'forum_last_poster_name', 'forum_last_poster_color', 'forum_postcount', 'forum_thanks', 'forum_likes', 'forum_notify', 'forum_limit_edit_time', 'forum_similar_topics', 'forum_topic_views', 'forum_sort_box', 'forum_kb_mode', 'forum_tags', 'forum_index_icons', 'forum_rules', 'forum_link', 'forum_link_internal', 'forum_link_hit_count', 'forum_link_hit', 'icon', 'prune_next', 'prune_enable', 'auth_view', 'auth_read', 'auth_post', 'auth_reply', 'auth_edit', 'auth_delete', 'auth_sticky', 'auth_announce', 'auth_globalannounce', 'auth_news', 'auth_cal', 'auth_vote', 'auth_pollcreate', 'auth_attachments', 'auth_download', 'auth_ban', 'auth_greencard', 'auth_bluecard', 'auth_rate'),
	...
	$table_prefix . 'plugins' => array('plugin_name', 'plugin_dir', 'plugin_enabled'),
	...
	$table_prefix . 'privmsgs' => array('privmsgs_id', 'privmsgs_type', 'privmsgs_subject', 'privmsgs_text', 'privmsgs_from_userid', 'privmsgs_to_userid', 'privmsgs_date', 'privmsgs_ip', 'privmsgs_enable_bbcode', 'privmsgs_enable_html', 'privmsgs_enable_smilies', 'privmsgs_enable_autolinks_acronyms', 'privmsgs_attach_sig', 'privmsgs_attachment'),
	...
	$table_prefix . 'sessions' => array('session_id', 'session_user_id', 'session_start', 'session_time', 'session_ip', 'session_browser', 'session_page', 'session_logged_in', 'session_admin'),
