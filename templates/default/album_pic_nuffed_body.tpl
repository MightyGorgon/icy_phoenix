	...
	<td class="row2" width="100%">
		<table width="100%" align="center" border="0" cellspacing="1" cellpadding="2">
			...
			<tr>
				...
				<td valign="top" align="left"><b><span class="genmed"><form name="select_all"><input name="BBCode" size="50" maxlength="100" value="{PIC_BBCODE}" type="text" readonly="readonly" onclick="this.form.BBCode.focus();this.form.BBCode.select();"/></form></span></b></td>
			</tr>
			<tr>
