...
<tr>
	...
	<td style="padding-left: 7px; padding-right: 7px; vertical-align: top;">
	...
	<td width="180" style="vertical-align: top;"><!-- BEGIN right_blocks_row -->{right_blocks_row.CMS_BLOCK}<!-- END right_blocks_row --></td>
</tr>
</table>
