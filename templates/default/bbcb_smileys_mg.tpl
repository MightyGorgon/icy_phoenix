...
<tr>
	<td class="cat" colspan="{S_SMILIES_COLSPAN}" align="center">
		<input type="button" class="liteoption" name="smiles_button" value="{L_MORE_SMILIES}" onclick="openAllSmiles();" />
	</td>
</tr>
...
<tr>
	<td class="cat" align="center">
		<input type="button" class="liteoption" value="{L_UPLOAD_IMAGE}" style="width: 135px" onclick="window.open('{U_UPLOAD_IMAGE}','_upload_image','height=300,width=700,resizable=yes,scrollbars=no'); return false;" />
	</td>
</tr>
</table>
