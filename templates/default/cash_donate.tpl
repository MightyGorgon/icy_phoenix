...
<tr><th class="tdnw" colspan="2">{L_DONATE_TO}</th></tr>
<tr>
...
<tr>
	...
	<table>
		<tr>
			...
			<td class="row2 row-center tw75px"><span class="gen">{L_DONATE}</span></td>
			<td class="row3 row-center tw75px"><span class="gen">{DONATER}</span></td>
		</tr>
		<!-- BEGIN cashrow -->
		<tr>
