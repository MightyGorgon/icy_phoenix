{IMG_THL}{IMG_THC}<span class="forumlink">{FL_TITLE}</span>{IMG_THR}<table class="forumlinenb">
<!-- BEGIN cat_row -->
<tr>
		...
		<div id="menu_cat_{cat_row.CAT_ID}_h" style="display: inline; position: relative;padding-top:0px;padding-bottom:0px;">
			<table class="forumline-no2 p2px">
				...
				<tr>
					...
					<td class="genmed tdalignl"><a href="{cat_row.forum_row.FORUM_LINK}">{cat_row.forum_row.FORUM_ITEM}</a></td>
				</tr>
				<!-- END forum_row -->
			</table>
		</div>
