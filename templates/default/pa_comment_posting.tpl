...
<tr><td class="row1g-left"><div class="post-text">{PRE_COMMENT}</div></td></tr>
</table>{IMG_TFL}{IMG_TFC}{IMG_TFR}
<br />
<!-- ENDIF -->
{IMG_THL}{IMG_THC}<span class="forumlink">{L_COMMENT_ADD}</span>{IMG_THR}<table class="forumlinenb">
<tr>
	<td class="row1 tw22pct"><span class="gen"><b>{L_COMMENT_TITLE}</b></span></td>
	<td class="row2 tw78pct"><input type="text" name="subject" size="45" maxlength="60" style="width: 98%;" tabindex="2" class="post" value="{SUBJECT}" /></td></td>
</tr>
<tr>
	<td class="row1">
		<table>
