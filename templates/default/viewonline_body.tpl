...
<tr>
	<th class="tw35pct">{L_USERNAME}</th>
	<th class="tw25pct">{L_LAST_UPDATE}</th>
	<th class="tw40pct">{L_FORUM_LOCATION}</th>
</tr>
<tr>
...
<!-- BEGIN reg_user_row -->
<tr>
	<td class="{reg_user_row.ROW_CLASS}h" data-href="{reg_user_row.U_USER_PROFILE}">{reg_user_row.USERNAME}&nbsp;{reg_user_row.USER_OS_IMG}&nbsp;{reg_user_row.USER_BROWSER_IMG}</td>
	<td class="{reg_user_row.ROW_CLASS} row-center tdnw"><span class="genmed">{reg_user_row.LASTUPDATE}</span></td>
	<td class="{reg_user_row.ROW_CLASS}h" data-href="{reg_user_row.U_FORUM_LOCATION}"><span class="gen"><a href="{reg_user_row.U_FORUM_LOCATION}">{reg_user_row.FORUM_LOCATION}</a></span></td>
</tr>
<!-- BEGIN switch_display_ips -->
<tr>
	<td class="{reg_user_row.ROW_CLASS}" colspan="3"><span class="gensmall">{L_IP}:&nbsp;<a href="{reg_user_row.U_HOSTNAME_LOOKUP}">{reg_user_row.IP}</a>&nbsp;&#187;&nbsp;<a href="{reg_user_row.U_WHOIS}" target="_blank">{L_WHOIS}</a>&nbsp;||&nbsp;{L_BROWSER}:&nbsp;{reg_user_row.USER_AGENT}</span></td>
</tr>
...
<tr>
	<td class="{guest_user_row.ROW_CLASS}h"><span class="genmed">{guest_user_row.USERNAME}&nbsp;{guest_user_row.USER_OS_IMG}&nbsp;{guest_user_row.USER_BROWSER_IMG}</span></td>
	<td class="{guest_user_row.ROW_CLASS} row-center tdnw"><span class="genmed">{guest_user_row.LASTUPDATE}</span></td>
	<td class="{guest_user_row.ROW_CLASS}h" data-href="{guest_user_row.U_FORUM_LOCATION}"><span class="gen"><a href="{guest_user_row.U_FORUM_LOCATION}">{guest_user_row.FORUM_LOCATION}</a></span></td>
</tr>
<!-- BEGIN switch_display_ips -->
<tr>
...
<tr>
	<td class="row-header tw70pct"><span class="genmed"><b>{L_RECENT_TOPICS}</b></span></td>
	<td class="row-header tw30pct"><span class="genmed"><b>{L_LAST_SEEN}</b></span></td>
</tr>
<tr>
	<td class="no-padding">
		<table>
	...
	<td class="no-padding">
		<table>
			<!-- BEGIN last_seen_row -->
			<tr><td class="row1"><span class="genmed">{switch_show_recent.last_seen_row.L_LSEEN_TIME}<b>{NAV_SEP}</b>{switch_show_recent.last_seen_row.U_LSEEN_LINK}</span></td></tr>
			<!-- END last_seen_row -->
		</table>
	</td>
</tr>
