...
<!-- BEGIN no_cat_parent -->
	...
	<tr>
		<td class="forum-buttons2" align="left" colspan="4"><img src="{CAT_BLOCK_IMG}" style="vertical-align:middle;" />&nbsp;<span><a href="{no_cat_parent.U_CAT}">{no_cat_parent.CAT_NAME}</a></span></td>
	</tr>
	<!-- ELSE -->
	<tr>
...
<tr>
	...
	<td class="row2 row-center" nowrap="nowrap"><span class="postdetails"><img src="images/rates/rate_{file_rows.RATING}.png" /></td>
