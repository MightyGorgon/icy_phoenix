...
<!-- BEGIN no_cat_parent -->
	...
	<tr><td class="forum-buttons2" colspan="4"><img src="{CAT_BLOCK_IMG}" style="vertical-align: middle;" />&nbsp;<span><a href="{no_cat_parent.U_CAT}">{no_cat_parent.CAT_NAME}</a></span></td></tr>
	<!-- ELSE -->
	<tr>
...
<tr>
	...
	<th class="tw10pct">{L_FILE_SIZE}</th>
...
<!-- BEGIN file_rows -->
<tr>
	<td class="row1 row-center tw30px" style="padding-right: 5px;"><a href="{file_rows.U_FILE}" class="topiclink"><img src="{file_rows.PIN_IMAGE}" alt="" /></a></td>
	...
	<td class="row2 row-center tdnw"><span class="postdetails">{file_rows.FILE_SIZE}</td>
	<td class="row2 row-center tdnw"><span class="postdetails"><img src="images/rates/rate_{file_rows.RATING}.png" alt="" /></span></td>
...
<!-- IF NO_FILE -->
{IMG_THL}{IMG_THC}<span class="forumlink">{L_NO_FILES}</span>{IMG_THR}<table class="forumlinenb">
<tr><td class="row1g tdalignc"><span class="gen">{L_NO_FILES_CAT}</span></td></tr>
</table>{IMG_TFL}{IMG_TFC}{IMG_TFR}
<!-- ENDIF -->
