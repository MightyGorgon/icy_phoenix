...
<tr>
	<td id="var_width" class="tvalignt tdalignl tw160px" style="padding-right: 7px;">
		...
		<span class="forumlink">{L_CPL_NAV}</span>{IMG_THR}<table class="forumlinenb">
		<tr>
			<th style="cursor: pointer; text-align: left;" onclick="ShowHide('personal_profile', 'personal_profile2', 'personal_profile');">
			...
			<td class="row5">
				<div id="personal_profile2" class="nav-menu">
					...
					<tr>
						...
						<td class="genmed tdalignl"><a href="{U_CPL_REGISTRATION_INFO}">{L_CPL_REG_INFO}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_DELETE_ACCOUNT}">{L_CPL_DELETE_ACCOUNT}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_PROFILE_INFO}">{L_CPL_PROFILE_INFO}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_ZEBRA}">{L_CPL_ZEBRA}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_PROFILE_VIEWED}">{L_CPL_PROFILE_VIEWED}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_AVATAR_PANEL}">{L_CPL_AVATAR_PANEL}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_SIGNATURE}">{L_CPL_SIG_EDIT}</a></td>
					</tr>
					</table>
				</div>
		...
		<tr>
			<th style="cursor: pointer; text-align: left;" onclick="ShowHide('settings_options', 'settings_options2', 'settings_options');">
		...
		<tr>
			<td class="row5">
				<div id="settings_options2" class="nav-menu">
					...
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_PREFERENCES}">{L_CPL_PREFERENCES}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_BOARD_SETTINGS}">{L_CPL_BOARD_SETTINGS}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_CALENDAR_SETTINGS}">{L_Calendar_settings}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_SUBFORUM_SETTINGS}">{L_Hierarchy_setting}</a></td>
					</tr>
					<!-- BEGIN login_sec_link -->
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_LOGIN_SEC}">{L_LOGIN_SEC}</a></td>
					</tr>
					<!-- END login_sec_link -->
					</table>
				</div>
		...
		<tr>
			<th style="cursor: pointer; text-align: left;" onclick="ShowHide('private_messages', 'private_messages2', 'private_messages');">
		...
		<tr>
			<td class="row5">
				<div id="private_messages2" class="nav-menu">
					...
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_NEWMSG}">{L_CPL_NEWMSG}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_PRIVATEMSGS}">{PRIVATE_MESSAGE_INFO}</a></td>
					</tr>
					<!--
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_INBOX}">{L_CPL_INBOX}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_OUTBOX}">{L_CPL_OUTBOX}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_SAVEBOX}">{L_CPL_SAVEBOX}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_SENTBOX}">{L_CPL_SENTBOX}</a></td>
					</tr>
					-->
					</table>
				</div>
		...
		<tr>
			<th style="cursor: pointer; text-align: left;" onclick="ShowHide('more_info', 'more_info2', 'more_info');">
		...
		<tr>
			<td class="row5">
				<div id="more_info2" class="nav-menu">
					...
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_DRAFTS}">{L_CPL_DRAFTS}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_BOOKMARKS}">{L_CPL_BOOKMARKS}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_WATCHED_TOPICS}">{L_WATCHED_TOPICS}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_SUBSCFORUMS}">{L_CPL_SUBSCFORUMS}</a></td>
					</tr>
					<!-- BEGIN switch_show_digests -->
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_DIGESTS}">{L_DIGESTS}</a></td>
					</tr>
					<!-- END switch_show_digests -->
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_OWN_POSTS}">{L_CPL_OWN_POSTS}</a></td>
					</tr>
					<tr>
						<td class="tdalignl tw8px">{IMG_NAV_MENU_SEP}</td>
						<td class="genmed tdalignl"><a href="{U_CPL_OWN_PICTURES}">{L_CPL_OWN_PICTURES}</a></td>
					</tr>
					</table>
				</div>
