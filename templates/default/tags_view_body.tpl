...
<!-- BEGIN row -->
<tr>
	<td class="row1 row-center tw22px"><img src="{row.TOPIC_FOLDER_IMG}" alt="{row.L_TOPIC_FOLDER_ALT}" title="{row.L_TOPIC_FOLDER_ALT}" style="margin-right: 4px;" /></td>
	...
	<td class="row3 row-center-small tdnw" style="padding-top: 0px; padding-left: 2px; padding-right: 2px;">{row.FIRST_POST_TIME}<br />{row.FIRST_AUTHOR}</td>
