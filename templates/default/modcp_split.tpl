...
{IMG_THL}{IMG_THC}<span class="forumlink">{L_SPLIT_TOPIC}</span>{IMG_THR}<table class="forumlinenb">
<tr><th colspan="3"><span class="gensmall">{L_SPLIT_TOPIC_EXPLAIN}</span></th></tr>
<tr>
	<td class="row1 tdnw"><span class="gen">{L_SPLIT_SUBJECT}</span></td>
	<td class="row2" colspan="2"><input name="subject" class="post" type="text" size="45" maxlength="120" style="width: 350px" /></td>
</tr>
<tr>
	<td class="row1 tdnw"><span class="gen">{L_SPLIT_FORUM}</span></td>
...
<tr>
	<th>{L_AUTHOR}</th>
	<th>{L_MESSAGE}</th>
	<th class="tdnw"><input type="checkbox" name="check_all_box" onclick="toggle_check_all()" /></th>
</tr>
<!-- BEGIN postrow -->
<tr>
	...
	<td class="row1g tw5pct">&nbsp;{postrow.S_SPLIT_CHECKBOX}&nbsp;</td>
</tr>
<tr><td class="spaceRow" colspan="3"><img src="{SPACER}" width="1" height="3" alt="" /></td></tr>
<!-- END postrow -->
<tr>
