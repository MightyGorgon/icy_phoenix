		...
		<table class="forumline" width="100%" cellspacing="0">
			...
			<tr>
				<td class="row1 row-center">
					<img src="{ranks_special.IMAGE}" alt="{ranks_special.RANK}" title="{ranks_special.RANK}" border="0"><br />
					<span class="gensmall"><b>{ranks_special.RANK_SPECIAL_DES}</b></span>
				</td>
				<td class="row1 row-center">
					<span class="genmed"><b>{ranks_special.RANK}</b></span>
				</td>
			</tr>
			<!-- END ranks_special -->
			<tr>
	...
	<td width="49%" align="center" valign="top">
		<table class="forumline" width="100%" cellspacing="0">
			...
			<tr>
				...
				<td class="row1 row-center">
					<span class="genmed"><b>{ranks_normal.RANK}</b></span>
				</td>
				<td class="{ranks_normal.ROW_CLASS} row-center">
					<span class="genmed"><b>{ranks_normal.RANK_MIN}</b></span>
				</td>
			</tr>
			<!-- END ranks_normal -->
			<tr>
