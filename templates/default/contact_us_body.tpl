...
<tr>
	<td class="row1 tw22pct"><span class="gen"><b>{L_SENDER}</b></span></td>
	<td class="row2 tw78pct"><span class="gen"><input type="text" name="sender" size="45" maxlength="100" style="width:450px" tabindex="2" class="post" value="{SENDER}" /></span></td>
</tr>
<tr>
...
<!-- ENDIF -->
<tr>
	<td class="row1"><span class="gen"><b>{L_MESSAGE_BODY}</b></span><br /><span class="gensmall">{L_MESSAGE_BODY_DESC}</span></td>
