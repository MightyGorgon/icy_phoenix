...
<tr>
	...
	<tr>
	<!-- IF HL_BLOCK -->
	<td id="var_width" width="{HEADER_WIDTH}" valign="top">
	<div id="quick_links2" style="padding-top:5px;display:none;margin-left:0px;text-align:left;position:relative;float:left;"><a href="javascript:ShowHide('quick_links','quick_links2','quick_links');setWidth({HEADER_WIDTH});" title="{L_SHOW} {L_QUICK_LINKS}"><img src="{IMG_NAV_MENU_APPLICATION}" alt="{L_SHOW} {L_QUICK_LINKS}" /></a></div>
