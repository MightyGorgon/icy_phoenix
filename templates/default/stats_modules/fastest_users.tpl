...
<tr>
	<th>{L_RANK}</th>
	<th width="20%" nowrap="nowrap">{L_USERNAME}</th>
	<th class="tw15pct">{L_TIME}</th>
	<th class="tw10pct">{L_POST_PER_DAY}</th>
...
<tr class="{stats_row.CLASS}h">
	...
	<td class="{stats_row.CLASS} row-center" style="background: none;" width="10%"><span class="gen">{stats_row.TIME}</span></td>
	<td class="{stats_row.CLASS} row-center" style="background: none;" width="10%"><span class="gen">{stats_row.RATE}</span></td>
