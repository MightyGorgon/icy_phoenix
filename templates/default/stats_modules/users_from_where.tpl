{IMG_THL}{IMG_THC}<span class="forumlink">{L_FROMWHERETITLE}</span>{IMG_THR}<table class="forumlinenb" width="100%" cellspacing="0" cellpadding="0">
<tr>
	<th width="20%">{L_RANK}</th>
	<th width="40%">{L_FROMWHERE}</th>
...
<tr class="{stats_row.CLASS}h">
	...
	<td class="{stats_row.CLASS} row-center" style="background: none;"><span class="gen">{stats_row.FROMWHERE}</span></td>
