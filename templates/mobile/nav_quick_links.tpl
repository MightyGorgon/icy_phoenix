<ul class="links">
    <li>
        <a href="javascript:void(0);" class="gradient">{L_MAIN_LINKS}</a>
        <ul class="menu">
            <!-- IF S_ADMIN -->
    ...
    <li>
        <a href="javascript:void(0);" class="gradient">{L_NEWS_LINKS}</a>
        <ul class="menu">
    ...
    <li>
        <a href="javascript:void(0);" class="gradient">{L_USERS_LINKS}</a>
        <ul class="menu">
