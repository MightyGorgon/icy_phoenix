	...
	<td align="left">
		<span class="gensmall">
			...
			<marquee id="recent_topics" behavior="scroll" direction="up" height="200" scrolldelay="100" scrollamount="2" loop="true" onmouseover="this.stop()" onmouseout="this.start()">
				...
				<a href="{scroll.recent_topic_row.U_TITLE}" title="{scroll.recent_topic_row.L_TITLE}">{scroll.recent_topic_row.L_TITLE}</a>{NAV_SEP}
				{scroll.recent_topic_row.S_POSTER}</b><br /><br />
			...
			<!-- BEGIN static -->
				...
				<a href="{static.recent_topic_row.U_TITLE}" title="{static.recent_topic_row.L_TITLE}">{static.recent_topic_row.L_TITLE}</a>{NAV_SEP}
				{scroll.recent_topic_row.S_POSTER}</b><br /><br />
				<!-- END recent_topic_row -->
			<!-- END static -->
		</span>
