...
<tr>
	...
	<th nowrap="nowrap">{L_BBUS_COLHEADER_POSTS}</th>
	<th nowrap="nowrap">{L_BBUS_COLHEADER_POSTRATE}</th>
	<th nowrap="nowrap">{L_BBUS_COLHEADER_PCTUTP}</th>
	<!-- BEGIN bb_usage_switch_pctutup_colhdr -->
	<!--
	<th nowrap="nowrap">%UTUP</th>
	-->
	<!-- END bb_usage_switch_pctutup -->
	<th nowrap="nowrap">{L_BBUS_COLHEADER_NEWTOPICS}</th>
...
<tr>
	...
	<td class="row2 row-center" valign="middle"><span class="gen">{bb_usage_section_row.bb_usage_forum_row.FORUM_TOPICRATE}</span></td>
	<td class="row2 row-center" valign="middle"><span class="gen">{bb_usage_section_row.bb_usage_forum_row.FORUM_TOPICS_WATCHED}&nbsp;</span></td>
</tr>
...
<tr>
	<td class="row1" width="100%" colspan="{bb_usage_switch_miscellaneous_info.bb_usage_switch_misc_prunedposts.BBUS_PRUNED_POSTS_COLSPAN1}">
		<span class="gen">{bb_usage_switch_miscellaneous_info.bb_usage_switch_misc_prunedposts.L_BBUS_PRUNED_POSTS}</span>
	</td>
	<td class="row2 row-center" valign="middle" colspan="{bb_usage_switch_miscellaneous_info.bb_usage_switch_misc_prunedposts.BBUS_PRUNED_POSTS_COLSPAN2}">
