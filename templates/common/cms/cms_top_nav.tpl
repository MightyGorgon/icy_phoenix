...
<a href="{U_CMS_ACP}" onmouseover="icon_text('{L_LINK_ACP}')" onmouseout="icon_text('&nbsp;')"><img src="{FULL_SITE_PATH}images/cms/cms_acp.png" alt="{L_LINK_ACP}" title="{L_LINK_ACP}" /></a>&nbsp;
...
<![endif]-->
<script type="text/javascript" src="{FULL_SITE_PATH}{T_COMMON_TPL_PATH}jquery/jquery.js"></script>
