...
<tr>
	<td valign="top" align="left" style="padding-right:7px;">
		...
		{IMG_THL}{IMG_THC}<img style="padding-top:3px;padding-right:6px;float:right;cursor:pointer;" src="{IMG_MINIMISE}" onclick="javascript:ShowHide('quick_links_cms','quick_links_cms2','quick_links_cms');setWidth(16);" alt="{L_SHOW}" />
		...
		<tr>
			<td class="row5">
				...
				<div id="cms_adv_management" style="display:'';position:relative;">
					<script type="text/javascript">
					<!--
