...
<!-- BEGIN file_list -->
<tr>
	<td width="3%" class="row1 row-center tvalignm"><input type="checkbox" name="select[{file_list.FILE_ID}]" value="yes" {file_list.CHECKBOX} /></td>
...
<!-- END file_list -->
<tr><td class="cat tdalignc" colspan="2"><input class="liteoption" type="submit" value="{L_DFILETITLE}" name="submit" /><input type="hidden" name="file" value="delete"></td></tr>
</table>
</form>
