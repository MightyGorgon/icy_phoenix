...
<tr>
	...
	<td class="{prune_overview.ROW_CLASS} row-center tvalignm"><input type="checkbox" name="prune_enable[{prune_overview.S_PRUNE_INDEX}]" value="1" {prune_overview.S_PRUNE_ENABLED} /></td>
</tr>
<!-- END prune_overview -->
