...
<tr>
	<td class="row1 tw60pct"><b>{L_YAHOO_SEARCH_SELECT_FORUMS}:</b><br /><span class="gensmall">{L_YAHOO_SEARCH_SELECT_FORUMS_EXPLAIN}</span></td>
	<td class="row2" width="40%">{S_FORUMS_SELECT}</td>
</tr>
<tr>
	<td class="row1 tw60pct"><b>{L_YAHOO_SEARCH_SAVEPATH}:</b><br /><span class="gensmall">{L_YAHOO_SEARCH_SAVEPATH_EXPLAIN}</span></td>
...
<tr><td class="cat tdalignc" colspan="2"><input type="submit" value="{L_YAHOO_SEARCH_GENERATE_FILE}" name="submit" class="mainoption" /></td></tr>
</table>
