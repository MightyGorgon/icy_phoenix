...
<tr>
	...
	<td class="row2" width="40%"><input type="text" name="search_savepath" value="{SEARCH_SAVEPATH}" /></td>
</tr>
<tr>
	<td class="row1"><b>{L_YAHOO_SEARCH_ADDITIONAL_URLS}:</b><br /><span class="gensmall">{L_YAHOO_SEARCH_ADDITIONAL_URLS_EXPLAIN}</span></td>
	<td class="row2"><textarea name="additional_urls" rows="5" cols="50">{ADDITIONAL_URLS}</textarea></td>
</tr>
<tr>
...
<tr>
	...
	<td class="row2"><input type="text" name="compression_level" value="{COMPRESSION_LEVEL}" size="1" maxlength="1" /></td>
</tr>
