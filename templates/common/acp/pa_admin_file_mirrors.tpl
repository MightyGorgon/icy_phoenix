...
<tr>
	...
	<td class="row2"><input type="file" size="50" name="userfile[{row.MIRROR_ID}]" maxlength="{FILESIZE}" class="post" /></td>
</tr>
<tr>
...
<tr>
	...
	<td class="row2"><input type="text" class="post" size="50" name="download_url[{row.MIRROR_ID}]" value="{row.MIRROR_URL}" /></td>
</tr>
