	...
	<tr>
		<td width="48%" align="left" valign="top">
			<table class="forumline" width="100%" cellspacing="0" cellpadding="0" border="0">
				...
				<tr><td class="row2 row-center"><img src="{IMG_ICON_1}" border="0" title="{L_PICTURE_ALT}" alt="{L_PICTURE_ALT}"></td></tr>
				<tr>
					<td class="row1">
					<br />
					{L_DONATE_EXPL}
			...
			<table class="forumline" width="100%" cellspacing="0" cellpadding="0" border="0">
				...
				<tr><td class="row2 row-center"><img src="{IMG_ICON_3}" border="0" title="{L_PICTURE_ALT}" alt="{L_PICTURE_ALT}"></td></tr>
				<tr>
					<td class="row1">
					<br />
					{L_THANKS_TO_TEXT}
		...
		<td width="48%" valign="top">
			<table class="forumline" width="100%" cellspacing="0" cellpadding="0" border="0">
				...
				<tr><td class="row2 row-center"><img src="{IMG_ICON_2}" border="0" title="{L_PICTURE_ALT}" alt="{L_PICTURE_ALT}"></td></tr>
				<tr>
			...
			<table class="forumline" width="100%" cellspacing="0" cellpadding="0" border="0">
				<tr><th>{L_INFO}</th></tr>
				<tr><td class="row2 row-center"><img src="{IMG_ICON_4}" border="0" title="{L_PICTURE_ALT}" alt="{L_PICTURE_ALT}"></td></tr>
				<tr>
					<td class="row1">
