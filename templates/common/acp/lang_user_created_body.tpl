...
<tr>
	...
	<td class="{row.COLOR} row-center" nowrap="nowrap"><span class="gen"><a href="{row.U_PACK_NORMAL}">{row.L_EDIT}</a></span></td>
...
<tr>
	<td class="row1" valign="top"><span class="genmed">{L_SEARCH_WORDS}</span><br /><span class="gensmall">{L_SEARCH_WORDS_EXPLAIN}</span><br /></td>
	<td class="row2">
...
<tr>
	<td class="row1" valign="top"><span class="genmed">{L_SEARCH_IN}</span><br /><span class="gensmall">{L_SEARCH_IN_EXPLAIN}</span><br /></td>
	<td class="row2">
