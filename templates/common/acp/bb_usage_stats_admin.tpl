...
<tr>
	...
	<td class="row2">
		...
		<tr>
			...
			<td class="row3"><input id="chkVLAnonymous" {BBUS_VIEWLEVEL_ANONYMOUS_CHKED} type="checkbox" onclick=" setValue_new(this.checked, 'bb_usage_stats_viewlevel', {BBUS_VIEWLEVEL_ANONYMOUS_FLAGVALUE});" /></td>
		</tr>
		<tr>
			...
			<td class="row2"><input id="chkVLSelf" {BBUS_VIEWLEVEL_SELF_CHKED} type="checkbox" onclick=" setValue_new(this.checked, 'bb_usage_stats_viewlevel', {BBUS_VIEWLEVEL_SELF_FLAGVALUE});" /></td>
		</tr>
		<tr>
			...
			<td class="row3"><input id="chkVLUsers" {BBUS_VIEWLEVEL_USERS_CHKED} type="checkbox" onclick=" setValue_new(this.checked, 'bb_usage_stats_viewlevel', {BBUS_VIEWLEVEL_USERS_FLAGVALUE});" /></td>
		</tr>
		<tr>
			...
			<td class="row2"><input id="chkVLModerators" {BBUS_VIEWLEVEL_MODERATORS_CHKED} type="checkbox" onclick=" setValue_new(this.checked, 'bb_usage_stats_viewlevel', {BBUS_VIEWLEVEL_MODERATORS_FLAGVALUE});" /></td>
		</tr>
		<tr>
			...
			<td class="row3"><input id="chkVLAdmins" {BBUS_VIEWLEVEL_ADMINS_CHKED} type="checkbox" onclick=" setValue_new(this.checked, 'bb_usage_stats_viewlevel', {BBUS_VIEWLEVEL_ADMINS_FLAGVALUE});" /></td>
		</tr>
		<tr>
			...
			<td class="row2"><input name="chkVLSpecialGrp" {BBUS_VIEWLEVEL_SPECIALGRP_CHKED} type="checkbox" onclick=" setValue_new(this.checked, 'bb_usage_stats_viewlevel', {BBUS_VIEWLEVEL_SPECIALGRP_FLAGVALUE});" /></td>
		</tr>
		</table>
		<br />
...
<tr>
	...
	<td class="row2">
		...
		<tr>
			...
			<td class="row2"><input id="chkVOShowAllForums" {BBUS_VIEWOPTION_SHOW_ALL_FORUMS_CHKED} type="checkbox" onclick=" setValue_new(this.checked, 'bb_usage_stats_viewoptions', {BBUS_VIEWOPTION_SHOW_ALL_FORUMS_FLAGVALUE});" /></td>
		</tr>
		<tr>
			...
			<td class="row3"><input id="chkVOPctUTUPColumnVisible" {BBUS_VIEWOPTION_PCTUTUP_COLUMN_VISIBLE_CHKED} type="checkbox" onclick=" setValue_new(this.checked, 'bb_usage_stats_viewoptions', {BBUS_VIEWOPTION_PCTUTUP_COLUMN_VISIBLE_FLAGVALUE});" /></td>
		</tr>
		<tr>
			...
			<td class="row2"><input id="chkVOMiscSectionVisible" {BBUS_VIEWOPTION_MISC_SECTION_VISIBLE_CHKED} type="checkbox" onclick=" setValue_new(this.checked, 'bb_usage_stats_viewoptions', {BBUS_VIEWOPTION_MISC_SECTION_VISIBLE_FLAGVALUE});" /></td>
		</tr>
		<tr>
			...
			<td class="row3"><input id="chkVOMiscTotPrunedPosts" {BBUS_VIEWOPTION_MISC_TOTPRUNEDPOSTS_CHKED} type="checkbox" onclick=" setValue_new(this.checked, 'bb_usage_stats_viewoptions', {BBUS_VIEWOPTION_MISC_TOTPRUNEDPOSTS_FLAGVALUE});" /></td>
		</tr>
		<tr>
			...
			<td class="row2"><input id="chkVOViewerScalablePR" {BBUS_VIEWOPTION_VIEWER_SCALABLE_PR_CHKED} type="checkbox" onclick=" setValue_new(this.checked, 'bb_usage_stats_viewoptions', {BBUS_VIEWOPTION_VIEWER_SCALABLE_PR_FLAGVALUE});" /></td>
		</tr>
		<tr>
			...
			<td class="row3"><input id="chkVOViewerScalableTR" {BBUS_VIEWOPTION_VIEWER_SCALABLE_TR_CHKED} type="checkbox" onclick=" setValue_new(this.checked, 'bb_usage_stats_viewoptions', {BBUS_VIEWOPTION_VIEWER_SCALABLE_TR_FLAGVALUE});" /></td>
		</tr>
		</table>
		<br />
