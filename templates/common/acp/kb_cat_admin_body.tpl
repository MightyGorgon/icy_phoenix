...
<tr>
	...
	<td class="{catrow.ROW_CLASS}" align="center"><span class="post-buttons">{catrow.U_EDIT} {catrow.U_DELETE}</span></td>
</tr>
<!-- BEGIN subrow -->
<tr>
	...
	<td class="{catrow.subrow.ROW_CLASS}" align="center"><span class="post-buttons">{catrow.subrow.U_EDIT} {catrow.subrow.U_DELETE}</span></td>
</tr>
	<!-- END subrow -->
	<!-- END catrow -->
</table>
