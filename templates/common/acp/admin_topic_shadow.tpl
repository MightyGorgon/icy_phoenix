...
<!-- END emptyrow -->
<tr><td class="cat" colspan="6" height="28" align="center"><input type="submit" class="mainoption" value="{L_DELETE}">&nbsp;&nbsp;<input type="reset" class="liteoption" value="{L_CLEAR}"></td></tr>
</table>
</form>
...
<tr><th colspan="3"><span class='catTitle'>{L_DELETE_FROM_EXPLAN}</span></th></tr>
<tr>
