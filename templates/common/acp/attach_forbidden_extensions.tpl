...
<tr>
	<td class="row1 row-center tvalignm"><input type="text" size="8" maxlength="15" name="add_extension" class="post" value=""/></td>
...
<!-- BEGIN extensionrow -->
<tr>
	<td class="row1 row-center tvalignm"><span class="postdetails">{extensionrow.EXTENSION_NAME}</span></td>
	<td class="row2 row-center tvalignm"><input type="checkbox" name="extension_id_list[]" value="{extensionrow.EXTENSION_ID}" /></td>
</tr>
<!-- END extensionrow -->
