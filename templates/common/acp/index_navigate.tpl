...
<!-- BEGIN catrow -->
<tr class="forumline"><th style="cursor:pointer;cursor:hand;text-align:left;vertical-align:middle;" onclick="onMenuCatClick('{catrow.MENU_CAT_ID}');">{catrow.MENU_CAT_ICON}{catrow.ADMIN_CATEGORY}</th></tr>
<tr>
